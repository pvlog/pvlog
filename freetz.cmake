...
set(CMAKE_C_COMPILER   ${FREETZ_PATH}/toolchain/target/bin/mipsel-linux-cc) 
set(CMAKE_CXX_COMPILER ${FREETZ_PATH}/toolchain/target/bin/mipsel-linux-c++)
...
set(CMAKE_C_FLAGS "-Os -O2 -static -s -pipe -march=4kc -Wa,--trap")
set(CMAKE_CXX_FLAGS "-Os -O2 -static -s -pipe -march=4kc -Wa,--trap")
