...
set(ODB_COMPILE_OUTPUT_DIR "${CMAKE_CURRENT_BINARY_DIR}/odb_gen/models")
...
function(odb_compile outvar)
	...
	message(STATUS "standard: ${PARAM_STANDARD}")
	...
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z][a-z]*)/\\L$1/")
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z][a-z]*)([A-Z][a-z]*)/\\L$1_$2/")
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z][a-z]*)([A-Z][a-z]*)([A-Z][a-z]*)/\\L$1_$2_$3/")
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z][a-z]*)([A-Z][a-z]*)([A-Z][a-z]*)([A-Z][a-z]*)/\\L$1_$2_$3_$4/")
