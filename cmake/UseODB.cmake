...
function(odb_compile outvar)
	...
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z]+)([A-Z][a-z]+)/\\L$1_$2/")
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z]+)([A-Z][a-z]+)([A-Z][a-z]+)/\\L$1_$2_$3/")
	list(APPEND ODB_ARGS --sql-name-regex "/([A-z]+)([A-Z][a-z]+)([A-Z][a-z]+)([A-Z][a-z]+)/\\L$1_$2_$3_$4/")
