...
public:
    ...
    int64_t getInt64() const
    {
    		switch (type) {
    			...
    			case Int16 : return data.int64; break;
    			default    : PVLOG_EXCEPT("Can not convert to Int64!");
    		}
    }
    ...
    int32_t getInt32() const
    {
      	switch (type) {
      		case Int32 : //Fallthrough
      		case Int16 :
      			return static_cast<int32_t>(data.int64); break;
      		case Int64 :
      			if ((data.int64 <= std::numeric_limits<int32_t>::min()) &&
    						(data.int64 >= std::numeric_limits<int32_t>::max()))
    ...
    {
		switch (type) {
			case Int16 : return static_cast<int16_t>(data.int64); break;
			case Int32 : //Fallthrough
			case Int64 : //Fallthrough
				if ((data.int64 <= std::numeric_limits<int16_t>::max()) &&
						(data.int64 >= std::numeric_limits<int16_t>::min()))
