...
//
//	void getAc(Ac* ac, uint32_t inverterId);
//
//
//	/**
...
//	 */
//	void getDc(Dc* dc, uint32_t inverterId);
//
//
//	/**
...
//	 * @param inverterId serial/id of inverter.
//	 */
//	void getStats(Stats* stats, uint32_t inverterId);
//
//
//
//	void getStatus(Status* status, uint32_t inverterId);
//
//
//	/**
//};
...
//	 * @return
//	 */
//	std::vector<std::string> getOpenPlants();
//
//	/**
